    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                connectionString = connectionString ?? "IdSvr3Config";//ConfigurationManager.ConnectionStrings[0].ConnectionString;
                ...
                file = file?? @"D:\_Works\DevModel\IdentityServer3.EntityFramework.Cli-master\source\Cli\data.json";

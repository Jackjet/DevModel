...
namespace Baibaomen.DevModel.Businsess.Services
{
    public class PropertyCommunicationService
    {
        ...
        /// <returns></returns>
        public async Task AddAsync(Communication communication, int? operatorId = null)
        {
        ...
        /// <returns></returns>
        public async Task<Communication> UpdateAsync(int id, Func<Communication, Communication> updateAction, int? operatorId = null)
        {
